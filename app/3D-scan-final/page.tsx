...
export default function LiquidMask(props: Props) {
    ...
    const mapTexture = (normalizedTexture: number) => {
    ...
    `
        ...
        const render = () => {
            ...
            if (isCanvasMode && preview) {
                ...
                uniforms.u_radius.value = mapRadius(radius) * 0.8

                // Also adjust texture parameters in Canvas mode for consistency
                const canvasTextureParams = mapTexture(texture * 1.1) // Boost texture in Canvas mode
