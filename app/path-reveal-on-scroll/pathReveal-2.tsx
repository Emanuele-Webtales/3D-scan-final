...
export default function PathReveal(props: any) {
    ...
    // Progress MV driven by window scroll relative to this component's absolute top
    ...
    const startPositionRef = React.useRef<number>(0)
    ...
    // Strategy: compute absolute top by temporarily setting position: static on the sticky parent (if any)
...
addPropertyControls(PathReveal, {
    ...
    // Scroll mapping driven by absolute start (px) and length (px)
